...
desired_signal = audioread('chin-chan-chon-chi-chicha-chochi.wav');
[noise_signal_in, Fs] = audioread('noise_chin-chan-chon-chi-chicha-chochi.wav');

order = 2048; % Порядок фильтра (сколько предыдущих значений берется)
step_size = 1.2; % Шаг обучения (изменение весов при каждой итерации)
...
audiowrite('output_nlms.wav', output_signal, Fs);
